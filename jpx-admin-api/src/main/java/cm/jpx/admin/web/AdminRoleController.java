...
import cm.jpx.db.domain.LitemallPermission;
import cm.jpx.db.domain.LitemallRole;
...
import static cm.jpx.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static cm.jpx.admin.util.AdminResponseCode.ROLE_USER_EXIST;
