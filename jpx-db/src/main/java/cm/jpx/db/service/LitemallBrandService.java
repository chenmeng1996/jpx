...
import cm.jpx.db.dao.LitemallBrandMapper;
import cm.jpx.db.domain.LitemallBrand;
import cm.jpx.db.domain.LitemallBrand.Column;
import cm.jpx.db.domain.LitemallBrandExample;
