...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.cm.jpx.wx"));
        System.out.println(environment.getProperty("logging.level.cm.jpx.admin"));
        System.out.println(environment.getProperty("logging.level.cm.jpx"));
    }
